(function(window, document, ionic) {
  ...
  var self = ionic.Platform = {
     ...
     */
    isIPad: function() {
      if (/iPad/i.test(self.navigator.platform) || (self.navigator.platform === 'MacIntel' && self.navigator.maxTouchPoints > 0)) {
        return true;
      }
    ...
    setPlatform: function(n) {
      ...
      } else if (/iPhone|iPad|iPod/.test(self.ua) || (self.navigator.platform === 'MacIntel' && self.navigator.maxTouchPoints > 0)) {
        platformName = IOS;
      } else {
